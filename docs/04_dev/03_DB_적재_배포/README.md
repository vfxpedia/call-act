...
5. **[11_통합_DB_설정_가이드.md](./11_통합_DB_설정_가이드.md)** ✅
   - 통합 DB 설정 및 적재 가이드
   - 키워드 사전 및 Teddycard 데이터 적재

6. **[12_Git_커밋_가이드.md](./12_Git_커밋_가이드.md)** ✅
   - 팀 레포와 개인 dev 폴더 동기화 후 Git 커밋 가이드
   - PR 생성 및 merge 프로세스

7. **[13_향후_전처리_작업_가이드.md](./13_향후_전처리_작업_가이드.md)** ✅ ⭐
   - Backend/RAG 개발 중 전처리 개선이 필요할 때를 위한 워크플로우
   - 브랜치 전략 및 체크리스트
