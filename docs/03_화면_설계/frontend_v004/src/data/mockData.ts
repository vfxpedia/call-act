...
export const employeesData = [
  ...
  { id: 'EMP-023', name: '손흥민', team: '상담2팀', position: '대리', consultations: 132, fcr: 93, avgTime: '4:35', rank: 7, trend: 'up' as const, status: 'active' as const, joinDate: '2023-12-10', email: 'son@example.com', phone: '010-1234-5679' },
  
  // 8위: 서지은 (상담3팀) - 131건, FCR 94%, 4:33
  { id: 'EMP-036', name: '서지은', team: '상담3팀', position: '사원', consultations: 131, fcr: 94, avgTime: '4:33', rank: 8, trend: 'up' as const, status: 'active' as const, joinDate: '2023-12-05', email: 'seoje@example.com', phone: '010-4567-8923' },
  
  // 9위: 조현우 (상담1팀) - 130건, FCR 93%, 4:40
  { id: 'EMP-008', name: '조현우', team: '상담1팀', position: '대리', consultations: 130, fcr: 93, avgTime: '4:40', rank: 9, trend: 'up' as const, status: 'active' as const, joinDate: '2023-10-15', email: 'cho@example.com', phone: '010-3456-7891' },
  
  // 10위: 전지현 (상담2팀) - 129건, FCR 94%, 4:42
  { id: 'EMP-026', name: '전지현', team: '상담2팀', position: '대리', consultations: 129, fcr: 94, avgTime: '4:42', rank: 10, trend: 'up' as const, status: 'active' as const, joinDate: '2023-10-08', email: 'jeon@example.com', phone: '010-4567-8923' },
  
  // 11위: 이재성 (상담1팀) - 128건, FCR 94%, 4:38
  { id: 'EMP-015', name: '이재성', team: '상담1팀', position: '대리', consultations: 128, fcr: 94, avgTime: '4:38', rank: 11, trend: 'up' as const, status: 'active' as const, joinDate: '2023-09-20', email: 'leejs@example.com', phone: '010-0123-4568' },
  
  // 12위: 유진희 (상담3팀) - 128건, FCR 93%, 4:41
  { id: 'EMP-044', name: '유진희', team: '상담3팀', position: '대리', consultations: 128, fcr: 93, avgTime: '4:41', rank: 12, trend: 'up' as const, status: 'active' as const, joinDate: '2023-09-22', email: 'yujh@example.com', phone: '010-2345-6701' },
  
  // 13위: 홍길동 (상담1팀) - 127건, FCR 94%, 4:32
  { id: 'EMP-001', name: '홍길동', team: '상담1팀', position: '대리', consultations: 127, fcr: 94, avgTime: '4:32', rank: 13, trend: 'up' as const, status: 'active' as const, joinDate: '2024-01-15', email: 'hong@example.com', phone: '010-1234-5678' },
  
  // 14위: 한동훈 (상담3팀) - 127건, FCR 93%, 4:44
  { id: 'EMP-037', name: '한동훈', team: '상담3팀', position: '대리', consultations: 127, fcr: 93, avgTime: '4:44', rank: 14, trend: 'same' as const, status: 'active' as const, joinDate: '2023-10-20', email: 'handh@example.com', phone: '010-5678-9034' },
  
  // 15위: 유재석 (상담2팀) - 126건, FCR 93%, 4:46
  { id: 'EMP-029', name: '유재석', team: '상담2팀', position: '대리', consultations: 126, fcr: 93, avgTime: '4:46', rank: 15, trend: 'up' as const, status: 'active' as const, joinDate: '2023-11-25', email: 'yoo@example.com', phone: '010-7890-1256' },
  
  // 16위: 김영권 (상담1팀) - 125건, FCR 93%, 4:45
  { id: 'EMP-011', name: '김영권', team: '상담1팀', position: '대리', consultations: 125, fcr: 93, avgTime: '4:45', rank: 16, trend: 'up' as const, status: 'active' as const, joinDate: '2023-11-05', email: 'kimyk@example.com', phone: '010-6789-0124' },
  
  // 17위: 정수진 (상담2팀) - 125건, FCR 93%, 4:45 (동점이지만 joinDate가 늦음)
  { id: 'EMP-020', name: '정수진', team: '상담2팀', position: '사원', consultations: 125, fcr: 93, avgTime: '4:45', rank: 17, trend: 'up' as const, status: 'vacation' as const, joinDate: '2024-02-15', email: 'jung2@example.com', phone: '010-5678-9012' },
  
  // 18위: 정민우 (상담3팀) - 124건, FCR 92%, 4:47
  { id: 'EMP-035', name: '정민우', team: '상담3팀', position: '사원', consultations: 124, fcr: 92, avgTime: '4:47', rank: 18, trend: 'up' as const, status: 'active' as const, joinDate: '2024-01-25', email: 'jungmw@example.com', phone: '010-3456-7812' },
  
  // 19위: 김수현 (상담2팀) - 123건, FCR 92%, 4:48
  { id: 'EMP-025', name: '김수현', team: '상담2팀', position: '사원', consultations: 123, fcr: 92, avgTime: '4:48', rank: 19, trend: 'up' as const, status: 'active' as const, joinDate: '2024-03-22', email: 'kimsh@example.com', phone: '010-3456-7812' },
  
  // 20위: 강하늘 (상담3팀) - 122건, FCR 92%, 4:49
  { id: 'EMP-041', name: '강하늘', team: '상담3팀', position: '사원', consultations: 122, fcr: 92, avgTime: '4:49', rank: 20, trend: 'up' as const, status: 'active' as const, joinDate: '2024-03-11', email: 'kanghn@example.com', phone: '010-9012-3478' },
  
  // 21위: 김태희 (상담2팀) - 122건, FCR 92%, 4:50
  { id: 'EMP-022', name: '김태희', team: '상담2팀', position: '과장', consultations: 122, fcr: 92, avgTime: '4:50', rank: 21, trend: 'up' as const, status: 'active' as const, joinDate: '2023-08-15', email: 'kimth@example.com', phone: '010-9012-3456' },
  
  // 22위: 김진수 (상담1팀) - 121건, FCR 91%, 4:52
  { id: 'EMP-014', name: '김진수', team: '상담1팀', position: '사원', consultations: 121, fcr: 91, avgTime: '4:52', rank: 22, trend: 'up' as const, status: 'active' as const, joinDate: '2024-01-10', email: 'kimjs@example.com', phone: '010-9012-3457' },
  
  // 23위: 신동엽 (상담2팀) - 120건, FCR 91%, 4:55
  { id: 'EMP-031', name: '신동엽', team: '상담2팀', position: '사원', consultations: 120, fcr: 91, avgTime: '4:55', rank: 23, trend: 'up' as const, status: 'active' as const, joinDate: '2024-03-07', email: 'shin@example.com', phone: '010-9012-3478' },
  
  // 24위: 백승호 (상담1팀) - 119건, FCR 92%, 4:50
  { id: 'EMP-010', name: '백승호', team: '상담1팀', position: '사원', consultations: 119, fcr: 92, avgTime: '4:50', rank: 24, trend: 'up' as const, status: 'active' as const, joinDate: '2024-02-20', email: 'baek@example.com', phone: '010-5678-9013' },
  
  // 25위: 최영수 (상담1팀) - 118건, FCR 91%, 4:55
  { id: 'EMP-004', name: '최영수', team: '상담1팀', position: '사원', consultations: 118, fcr: 91, avgTime: '4:55', rank: 25, trend: 'same' as const, status: 'active' as const, joinDate: '2024-04-01', email: 'choi@example.com', phone: '010-6789-0123' },
  
  // 26위: 안수진 (상담3팀) - 118건, FCR 91%, 4:56
  { id: 'EMP-038', name: '안수진', team: '상담3팀', position: '사원', consultations: 118, fcr: 91, avgTime: '4:56', rank: 26, trend: 'up' as const, status: 'active' as const, joinDate: '2024-02-12', email: 'ansj@example.com', phone: '010-6789-0145' },
  
  // 27위: 박서준 (상담2팀) - 117건, FCR 91%, 4:58
  { id: 'EMP-024', name: '박서준', team: '상담2팀', position: '사원', consultations: 117, fcr: 91, avgTime: '4:58', rank: 27, trend: 'same' as const, status: 'active' as const, joinDate: '2024-01-18', email: 'parksj@example.com', phone: '010-2345-6701' },
  
  // 28위: 오수아 (상담3팀) - 116건, FCR 90%, 5:02
  { id: 'EMP-042', name: '오수아', team: '상담3팀', position: '사원', consultations: 116, fcr: 90, avgTime: '5:02', rank: 28, trend: 'same' as const, status: 'active' as const, joinDate: '2024-01-30', email: 'ohsa@example.com', phone: '010-0123-4589' },
  
  // 29위: 권경원 (상담1팀) - 116건, FCR 90%, 5:08
  { id: 'EMP-017', name: '권경원', team: '상담1팀', position: '사원', consultations: 116, fcr: 90, avgTime: '5:08', rank: 29, trend: 'same' as const, status: 'active' as const, joinDate: '2024-02-28', email: 'kwon@example.com', phone: '010-2345-6790' },
  
  // 30위: 박지성 (상담1팀) - 115건, FCR 91%, 5:05
  { id: 'EMP-006', name: '박지성', team: '상담1팀', position: '사원', consultations: 115, fcr: 91, avgTime: '5:05', rank: 30, trend: 'same' as const, status: 'active' as const, joinDate: '2024-05-20', email: 'parkjs@example.com', phone: '010-0123-4567' },
  
  // 31위: 이수근 (상담2팀) - 115건, FCR 90%, 5:08
  { id: 'EMP-033', name: '이수근', team: '상담2팀', position: '사원', consultations: 115, fcr: 90, avgTime: '5:08', rank: 31, trend: 'same' as const, status: 'active' as const, joinDate: '2024-04-20', email: 'leesg@example.com', phone: '010-1234-5690' },
  
  // 32위: 이민호 (상담2팀) - 114건, FCR 90%, 5:05
  { id: 'EMP-028', name: '이민호', team: '상담2팀', position: '사원', consultations: 114, fcr: 90, avgTime: '5:05', rank: 32, trend: 'same' as const, status: 'active' as const, joinDate: '2024-02-09', email: 'leemh@example.com', phone: '010-6789-0145' },
  
  // 33위: 정우영 (상담1팀) - 113건, FCR 90%, 5:00
  { id: 'EMP-012', name: '정우영', team: '상담1팀', position: '사원', consultations: 113, fcr: 90, avgTime: '5:00', rank: 33, trend: 'same' as const, status: 'active' as const, joinDate: '2024-03-15', email: 'jung@example.com', phone: '010-7890-1235' },
  
  // 34위: 박철수 (상담1팀) - 112건, FCR 92%, 5:10
  { id: 'EMP-003', name: '박철수', team: '상담1팀', position: '과장', consultations: 112, fcr: 92, avgTime: '5:10', rank: 34, trend: 'down' as const, status: 'active' as const, joinDate: '2023-05-10', email: 'park@example.com', phone: '010-4567-8901' },
  
  // 35위: 배지현 (상담3팀) - 112건, FCR 89%, 5:11
  { id: 'EMP-039', name: '배지현', team: '상담3팀', position: '사원', consultations: 112, fcr: 89, avgTime: '5:11', rank: 35, trend: 'down' as const, status: 'active' as const, joinDate: '2024-04-08', email: 'baejh@example.com', phone: '010-7890-1256' },
  
  // 36위: 송중기 (상담2팀) - 111건, FCR 89%, 5:12
  { id: 'EMP-027', name: '송중기', team: '상담2팀', position: '사원', consultations: 111, fcr: 89, avgTime: '5:12', rank: 36, trend: 'down' as const, status: 'active' as const, joinDate: '2024-04-14', email: 'song@example.com', phone: '010-5678-9034' },
  
  // 37위: 김채원 (상담3팀) - 110건, FCR 89%, 5:14
  { id: 'EMP-045', name: '김채원', team: '상담3팀', position: '사원', consultations: 110, fcr: 89, avgTime: '5:14', rank: 37, trend: 'down' as const, status: 'active' as const, joinDate: '2024-06-08', email: 'kimcw@example.com', phone: '010-3456-7812' },
  
  // 38위: 이강인 (상담1팀) - 110건, FCR 89%, 5:15
  { id: 'EMP-007', name: '이강인', team: '상담1팀', position: '사원', consultations: 110, fcr: 89, avgTime: '5:15', rank: 38, trend: 'down' as const, status: 'active' as const, joinDate: '2024-06-01', email: 'leekg@example.com', phone: '010-2345-6780' },
  
  // 39위: 강호동 (상담2팀) - 109건, FCR 88%, 5:22
  { id: 'EMP-030', name: '강호동', team: '상담2팀', position: '사원', consultations: 109, fcr: 88, avgTime: '5:22', rank: 39, trend: 'down' as const, status: 'active' as const, joinDate: '2024-05-30', email: 'kanghd@example.com', phone: '010-8901-2367' },
  
  // 40위: 윤서연 (상담1팀) - 108건, FCR 90%, 5:20
  { id: 'EMP-005', name: '윤서연', team: '상담1팀', position: '사원', consultations: 108, fcr: 90, avgTime: '5:20', rank: 40, trend: 'down' as const, status: 'inactive' as const, joinDate: '2024-01-20', email: 'yoon@example.com', phone: '010-8901-2345' },
  
  // 41위: 임윤아 (상담3팀) - 108건, FCR 88%, 5:20
  { id: 'EMP-043', name: '임윤아', team: '상담3팀', position: '사원', consultations: 108, fcr: 88, avgTime: '5:20', rank: 41, trend: 'down' as const, status: 'active' as const, joinDate: '2024-05-17', email: 'imya@example.com', phone: '010-1234-5690' },
  
  // 42위: 나상호 (상담1팀) - 107건, FCR 89%, 5:18
  { id: 'EMP-013', name: '나상호', team: '상담1팀', position: '사원', consultations: 107, fcr: 89, avgTime: '5:18', rank: 42, trend: 'down' as const, status: 'active' as const, joinDate: '2024-04-25', email: 'na@example.com', phone: '010-8901-2346' },
  
  // 43위: 김희철 (상담2팀) - 106건, FCR 87%, 5:28
  { id: 'EMP-032', name: '김희철', team: '상담2팀', position: '사원', consultations: 106, fcr: 87, avgTime: '5:28', rank: 43, trend: 'down' as const, status: 'active' as const, joinDate: '2024-06-15', email: 'kimhc@example.com', phone: '010-0123-4589' },
  
  // 44위: 황희찬 (상담1팀) - 105건, FCR 88%, 5:25
  { id: 'EMP-009', name: '황희찬', team: '상담1팀', position: '사원', consultations: 105, fcr: 88, avgTime: '5:25', rank: 44, trend: 'down' as const, status: 'active' as const, joinDate: '2024-07-10', email: 'hwang@example.com', phone: '010-4567-8902' },
  
  // 45위: 황인범 (상담1팀) - 102건, FCR 87%, 5:30
  { id: 'EMP-016', name: '황인범', team: '상담1팀', position: '사원', consultations: 102, fcr: 87, avgTime: '5:30', rank: 45, trend: 'down' as const, status: 'active' as const, joinDate: '2024-05-05', email: 'hwangib@example.com', phone: '010-1234-5679' },
];
...
export const frequentInquiriesData = [
  { id: 1, title: '카드 분실 신고 절차', category: '카드분실', views: 1245 },
  { id: 2, title: '해외 결제 활성화 방법', category: '해외결제', views: 987 },
  { id: 3, title: '연회비 환불 정책', category: '수수료문의', views: 856 },
  { id: 4, title: '포인트 적립 및 사용', category: '포인트', views: 743 },
  { id: 5, title: '카드 한도 증액 신청', category: '한도조회', views: 621 }
];

// ==================== 시뮬레이션 데이터 ====================
export const simulationsData = [
  { id: 1, title: '카드 분실 신고 기본 절차', category: '기본 상담', difficulty: '초급', status: 'completed' as const, score: 92, date: '2025-01-08' },
  { id: 2, title: '진상 고객 응대 마스터', category: '민원 대응', difficulty: '고급', status: 'in-progress' as const, score: null, date: null },
  { id: 3, title: '해외 결제 오류 처리', category: '기본 상담', difficulty: '중급', status: 'recommended' as const, score: null, date: null },
  { id: 4, title: '포인트 적립 문의 응대', category: '기본 상담', difficulty: '초급', status: 'recommended' as const, score: null, date: null },
  { id: 5, title: '긴급 상황 대응 훈련', category: '긴급 상황', difficulty: '고급', status: 'recommended' as const, score: null, date: null }
];