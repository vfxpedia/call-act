...
import { Play, Lock, Star, Clock, Trophy, BookOpen, Award } from 'lucide-react';
...
export default function SimulationPage() {
  ...
  // ⭐ Phase 11-2: localStorage에서 우수사례 로드 (실시간 연동)
  useEffect(() => {
            ...
            {consultations.filter(c => c.isBestPractice).length > 0 && (
              <div className="bg-white rounded-lg shadow-sm">
                <div className="p-3 border-b border-[#E0E0E0]">
                  ...
                  <p className="text-xs text-[#666666] mt-1">실제 우수 상담 사례를 시뮬레이션으로 학습하세요</p>
                </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    {consultations
                      ...
                      .map((consultation) => (
                        <div 
                          key={consultation.id}
                          className="border-2 border-[#FBBC04] bg-gradient-to-br from-[#FFFBF0] to-white rounded-lg p-3 hover:shadow-md transition-all cursor-pointer"
                        >
                          <div className="flex items-start justify-between mb-2">
                            <div className="flex-1">
                              ...
                              <h3 className="text-sm font-bold text-[#333333] mb-1">{consultation.category}</h3>
                              <p className="text-xs text-[#666666] line-clamp-2 mb-2">{consultation.content}</p>
                          ...
                          <div className="flex items-center justify-between pt-2 border-t border-[#FBBC04]/20">
