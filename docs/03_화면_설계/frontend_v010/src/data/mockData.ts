...
export const consultationsData = [
  { id: 'CS-20250105-1432', agent: '홍길동', customer: '김민수', category: '카드분실', status: '완료', content: '카드 분실 신고 접수 및 즉시 정지 처리. 재발급 신청 완료', datetime: '2025-01-05 14:32', duration: '05:12', isBestPractice: true, fcr: true, memo: '카드 분실 신고 및 재발급 처리 완료. 고객 만족도 높음' },
  { id: 'CS-20250105-1315', agent: '이영희', customer: '박철수', category: '해외결제', status: '진행중', content: '해외 결제 차단 해제 요청. 본인 확인 및 추가 서류 확인 중', datetime: '2025-01-05 13:15', duration: '07:45', isBestPractice: false, fcr: false, memo: '해외 결제 차단 해제 요청 처리 중. 추가 서류 대기' },
  { id: 'CS-20250105-1205', agent: '김민수', customer: '최영수', category: '수수료문의', status: '완료', content: '연회비 수수료 환불 조건 안내 및 처리 방법 설명', datetime: '2025-01-05 12:05', duration: '04:30', isBestPractice: false, fcr: true, memo: '연회비 수수료 환불 안내 완료' },
  { id: 'CS-20250105-1120', agent: '홍길동', customer: '강민지', category: '카드분실', status: '미완료', content: '카드 분실 신고 접수 후 고객 요청으로 보류 상태', datetime: '2025-01-05 11:20', duration: '03:20', isBestPractice: false, fcr: false, memo: '고객 요청으로 보류. 내일 재연락 예정' },
  { id: 'CS-20250105-1045', agent: '김태희', customer: '윤서연', category: '해외결제', status: '완료', content: '해외 결제 승인 처리 및 사용 가능 국가 안내', datetime: '2025-01-05 10:45', duration: '06:15', isBestPractice: true, fcr: true, memo: '해외 결제 승인 처리 완료. 우수 상담 사례' },
  { id: 'CS-20250105-0950', agent: '이영희', customer: '정수진', category: '기타', status: '완료', content: '일반 문의 사항 응대 및 해결', datetime: '2025-01-05 09:50', duration: '05:50', isBestPractice: false, fcr: true, memo: '일반 문의 응대 완료' },
  { id: 'CS-20250104-1650', agent: '김민수', customer: '윤서연', category: '카드분실', status: '완료', content: '카드 재발급 신청 접수 및 배송 주소 확인', datetime: '2025-01-04 16:50', duration: '04:15', isBestPractice: false, fcr: true, memo: '카드 재발급 신청 접수 완료' },
  { id: 'CS-20250104-1520', agent: '강민지', customer: '손흥민', category: '프로모션', status: '완료', content: '신규 프로모션 혜택 및 참여 방법 상세 안내', datetime: '2025-01-04 15:20', duration: '03:45', isBestPractice: false, fcr: true, memo: '신규 프로모션 상세 안내' },
  { id: 'CS-20250104-1340', agent: '박철수', customer: '이강인', category: '수수료문의', status: '완료', content: '수수료 정책 및 면제 조건 상세 설명', datetime: '2025-01-04 13:40', duration: '05:00', isBestPractice: false, fcr: false, memo: '수수료 정책 상세 설명' },
  { id: 'CS-20250104-1115', agent: '정수진', customer: '박지성', category: '해외결제', status: '완료', content: '해외 사용 설정 완료 및 이용 가능 국가 안내', datetime: '2025-01-04 11:15', duration: '04:50', isBestPractice: false, fcr: true, memo: '해외 사용 설정 완료' },
  { id: 'CS-20250104-1020', agent: '최은정', customer: '조현우', category: '포인트', status: '완료', content: '포인트 적립 내역 확인 및 사용 방법 안내', datetime: '2025-01-04 10:20', duration: '03:30', isBestPractice: false, fcr: true, memo: '포인트 적립 및 사용 안내' },
  { id: 'CS-20250104-0935', agent: '문성민', customer: '황희찬', category: '한도조회', status: '완료', content: '일시불 한도 조회 및 증액 신청 절차 안내', datetime: '2025-01-04 09:35', duration: '04:10', isBestPractice: false, fcr: true, memo: '일시불 한도 조회 및 증액 안내' },
  { id: 'CS-20250103-1710', agent: '손흥민', customer: '백승호', category: '카드분실', status: '완료', content: '긴급 카드 정지 처리 및 재발급 신청 접수', datetime: '2025-01-03 17:10', duration: '05:20', isBestPractice: false, fcr: true, memo: '긴급 카드 정지 및 재발급 처리' },
  { id: 'CS-20250103-1545', agent: '서지은', customer: '김영권', category: '프로모션', status: '완료', content: '이벤트 참여 방법 및 혜택 상세 안내', datetime: '2025-01-03 15:45', duration: '03:55', isBestPractice: false, fcr: true, memo: '이벤트 참여 방법 안내' },
  { id: 'CS-20250103-1420', agent: '전지현', customer: '정우영', category: '해외결제', status: '진행중', content: '해외 가맹점 결제 오류 원인 조사 중', datetime: '2025-01-03 14:20', duration: '06:30', isBestPractice: false, fcr: false, memo: '해외 가맹점 결제 오류 조사 중' },
  { id: 'CS-20250103-1310', agent: '조현우', customer: '나상호', category: '포인트', status: '완료', content: '적립 포인트 사용 가능 가맹점 및 조건 안내', datetime: '2025-01-03 13:10', duration: '04:22', isBestPractice: false, fcr: true, memo: '적립 포인트 사용 가능 가맹점 안내' },
  { id: 'CS-20250103-1155', agent: '이재성', customer: '김진수', category: '한도조회', status: '완료', content: '카드 한도 증액 신청 접수 및 심사 안내', datetime: '2025-01-03 11:55', duration: '03:48', isBestPractice: false, fcr: true, memo: '카드 한도 증액 신청 접수' },
  { id: 'CS-20250103-1030', agent: '강민지', customer: '황인범', category: '수수료문의', status: '완료', content: '해외 사용 수수료 정책 및 면제 조건 설명', datetime: '2025-01-03 10:30', duration: '05:35', isBestPractice: false, fcr: true, memo: '해외 사용 수수료 정책 설명' },
  { id: 'CS-20250102-1725', agent: '정민우', customer: '권경원', category: '기타', status: '완료', content: '결제일 변경 요청 처리 및 변경 완료', datetime: '2025-01-02 17:25', duration: '04:05', isBestPractice: false, fcr: true, memo: '결제일 변경 요청 처리 완료' },
  { id: 'CS-20250102-1540', agent: '한동훈', customer: '이영표', category: '프로모션', status: '완료', content: '신년 이벤트 참여 방법 및 혜택 상세 안내', datetime: '2025-01-02 15:40', duration: '03:28', isBestPractice: false, fcr: true, memo: '신년 이벤트 참여 방법 상세 안내' },
  { id: 'CS-20250102-1435', agent: '안수진', customer: '박서준', category: '카드분실', status: '완료', content: '긴급 카드 정지 처리 및 임시 카드 발급 안내', datetime: '2025-01-02 14:35', duration: '05:42', isBestPractice: false, fcr: true, memo: '긴급 카드 정지 및 임시 카드 발급' },
  { id: 'CS-20250102-1320', agent: '배지현', customer: '김수현', category: '해외결제', status: '완료', content: '해외 결제 실패 원인 분석 및 해결 방안 제시', datetime: '2025-01-02 13:20', duration: '06:18', isBestPractice: false, fcr: false, memo: '해외 결제 실패 원인 분석 및 해결' },
  { id: 'CS-20250102-1205', agent: '강하늘', customer: '송중기', category: '포인트', status: '완료', content: '포인트 소멸 예정 안내 및 사용 권유', datetime: '2025-01-02 12:05', duration: '04:12', isBestPractice: false, fcr: true, memo: '포인트 소멸 예정 안내 및 사용 권유' },
  { id: 'CS-20250102-1050', agent: '오수아', customer: '이민호', category: '한도조회', status: '완료', content: '일시불 한도 확인 및 이용 가능 금액 안내', datetime: '2025-01-02 10:50', duration: '03:55', isBestPractice: false, fcr: true, memo: '일시불 한도 확인 및 안내' },
  { id: 'CS-20250102-0935', agent: '임윤아', customer: '유재석', category: '수수료문의', status: '완료', content: '카드 대금 연체 수수료 정책 및 납부 방법 안내', datetime: '2025-01-02 09:35', duration: '05:08', isBestPractice: false, fcr: true, memo: '카드 대금 연체 수수료 안내' },
];
